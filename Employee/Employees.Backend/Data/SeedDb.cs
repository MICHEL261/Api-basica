...
namespace Employees.Backend.Data
{
    public class SeedDb
    {
        ...
        private async Task CheckEmployeesAsync()
        {
            ...
            new Employee { FirstName = "Sebastián", LastName = "Morales", IsActive = false, HireDate = new DateTime(2019, 11, 3), Salary = 1_100_000 },
            ...
            new Employee { FirstName = "Gabriel", LastName = "Ríos", IsActive = true, HireDate = new DateTime(2015, 12, 15), Salary = 1_450_000 },
            new Employee { FirstName = "Florencia", LastName = "Acosta", IsActive = true, HireDate = new DateTime(2014, 7, 8), Salary = 1_550_000 },

            new Employee { FirstName = "Tomás", LastName = "Luna", IsActive = true, HireDate = new DateTime(2023, 5, 4), Salary = 1_220_000 },
            ...
            new Employee { FirstName = "Agustín", LastName = "Cabrera", IsActive = false, HireDate = new DateTime(2019, 8, 30), Salary = 1_120_000 },
            ...
            new Employee { FirstName = "Benjamín", LastName = "Soto", IsActive = true, HireDate = new DateTime(2021, 2, 3), Salary = 1_370_000 },
            new Employee { FirstName = "Julia", LastName = "Pizarro", IsActive = true, HireDate = new DateTime(2020, 10, 19), Salary = 1_420_000 },
            new Employee { FirstName = "Iván", LastName = "Espinoza", IsActive = false, HireDate = new DateTime(2019, 5, 27), Salary = 1_130_000 },
            new Employee { FirstName = "Carla", LastName = "Gallardo", IsActive = true, HireDate = new DateTime(2018, 6, 2), Salary = 1_620_000 },
            new Employee { FirstName = "Simón", LastName = "Tapia", IsActive = true, HireDate = new DateTime(2017, 9, 16), Salary = 1_270_000 },
            ...
            new Employee { FirstName = "Mónica", LastName = "Arce", IsActive = false, HireDate = new DateTime(2022, 3, 12), Salary = 1_340_000 },
            ...
            new Employee { FirstName = "Eduardo", LastName = "Mejía", IsActive = false, HireDate = new DateTime(2019, 1, 18), Salary = 1_140_000 },
            new Employee { FirstName = "Adriana", LastName = "Castañeda", IsActive = true, HireDate = new DateTime(2018, 10, 22), Salary = 1_630_000 },
            new Employee { FirstName = "Óscar", LastName = "Zamora", IsActive = true, HireDate = new DateTime(2017, 7, 1), Salary = 1_280_000 },
            new Employee { FirstName = "Verónica", LastName = "Camacho", IsActive = false, HireDate = new DateTime(2016, 5, 14), Salary = 1_330_000 },
